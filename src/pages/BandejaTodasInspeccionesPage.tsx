        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span
              ...
              style={{ fontSize: 24, color: "#5B6ABF" }}
            >
              fact_check
            </span>
            <div className="topbar-title">
              Bandeja Inspección (Consulta Consolidada)
            </div>
          </div>
        </div>
      </div>
              ...
              {filtrados.length === 0 ? (
                <tr>
                  ...
                  >
                    <span
                      className="material-icons"
                      style={{ fontSize: 48, color: "#5B6ABF", opacity: 0.3 }}
                    >
                      fact_check
                    </span>
                ...
                filtrados.map((t) => {
                  ...
                  const tipoColor =
                    TIPO_INSPECCION_COLOR[t.tipoInspeccion || "HABILITACION"] ||
                    "#5B6ABF";
                  const tipoLabel =
                    TIPO_INSPECCION_LABEL[t.tipoInspeccion || "HABILITACION"] ||
                    t.tipoInspeccion;
                  ...
                  return (
                    <tr key={t.id}>
                      ...
                      <td
                        style={{ fontSize: 13, color: "var(--color-gray-700)" }}
                      >
                        {t.inspectorAsignado ||
                          t.agenteAsignado ||
                          "Sin Asignar"}
                              ...
                              options={[
                                {
                                  ...
                                  onClick: () =>
                                    navigate(
                                      user?.rol === "COORDINADOR"
                                        ? `/coordinador/ver-tramite/${t.id}`
                                        : `/inspector/ver-tramite/${t.id}`,
                                    ),
                                },
                                {
                          ...
                          <TableActionsMenu
                            options={[
                              ...
                              },
                              {
                                ...
                                onClick: () =>
                                  alert(
                                    `Historial de Inspección N° ${t.nroTramite}`,
                                  ),
                              },
                              {
